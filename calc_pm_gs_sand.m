...
% this script is for sand flats 
clear all;clc;clf;close all;
%% load half-hourly data from sand falts 
% load friction velocity (ustart) in m/s - only use values >= 0.3 m/s & < 2 m/s
...
sat_mixing_ratio = 0.622*(es./pa); % in kg H20/kg air 
...
z2 = 36.7; %reference height in meters
h = 21.8; %mean height of canopy in meters 
%calculate d and z0 from meyers et al. 1998 for profile =2
